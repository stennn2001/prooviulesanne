...
class CompanyAdmin(admin.ModelAdmin):
    list_display = [
        "name", "code", "type", "established_date", "total_capital",
        "owned_capital", "owners", "updated_at", "created_at"
    ]
    ...
    def owners(self, obj):
        ...
        if shareholders:
            ...
            return format_html(
                '<span style="color: red;">No shareholders</span>')
...
class ShareholderAdmin(admin.ModelAdmin):
    list_display = [
        "company_id", "get_shareholder", "shareholder_type", "is_founder",
        "share_amount"
    ]
    search_fields = [
        "company_id__name", "shareholder_person_id__first_name",
        "shareholder_person_id__last_name", "shareholder_company_id__name"
    ]
